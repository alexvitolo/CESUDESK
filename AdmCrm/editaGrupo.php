...
$result_Regiao = sqlsrv_prepare($conn, $sqlRegiao);
sqlsrv_execute($result_Regiao);

$sqlUnidade = "SELECT ID_UNIDADE
                     ,DESCRICAO
                  FROM DB_CRM_REPORT.dbo.tb_crm_unidade";

$result_Unidade = sqlsrv_prepare($conn, $sqlUnidade);
sqlsrv_execute($result_Unidade);
                         ...
                         <fieldset>
                          ...
                          <tr>
                            <td style="width:120px";><br>
                             <label style="margin-left: 15px">Unidade :</label>
                            </td>
                            <td align="left"><br>
                             <select name="unidade">
