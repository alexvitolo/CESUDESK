      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
            <h3><i class="fa fa-right"></i> Avaliações </h3>

            <!-- criar formulario -->
              <div class="row mt">
                  <div class="col-md-12">
                      <div class="content-panel">
                         <form name="Form" method="post" id="formulario" action="avaliacaoConhecimento.php" target="_blank">
<!-- DADOS PESSOAIS-->
                          <fieldset>
                          <legend> TESTE CONHECIMENTO </legend> 
...
(function(document) {
  ...
  document.addEventListener('readystatechange', function() {
    ...
    function getConfirmation(){
       ...
       if(  confirm(" Iniciar Avaliação ? ") == true ){
          return true;
       }
       else{
          return false;
