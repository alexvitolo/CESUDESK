      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
            <h3><i class="fa fa-right"></i> Cadastro Novo Conhecimento</h3>

            <!-- criar formulario -->
              <div class="row mt">
                  <div class="col-md-12">
                      <div class="content-panel">
                         <form name="Form" method="post" id="formulario" action="ValidaCadastroTipoTesteConheci.php" onSubmit="return enviardados();" >
<!-- DADOS PESSOAIS-->
                         <fieldset>
                          ...
                          <table cellspacing="10" style="vertical-align: middle">
                           <tr>
                            ...
                            <td align="left">
                             <input type="text" maxlength="45" size="50" name="DESC_CONHE" value="">
                            </td>
                            <td style="width:110px";>
                            ...
                            <td align="left"><br>
                             <select name="ID_GRUPO">
                                           ...
                                           <?php while ($row = sqlsrv_fetch_array($result_squilaGrupo)){ ?>
                                            <option value=<?php echo $row['ID_GRUPO']?> > <?php echo $row['DESCRICAO'] ?> </option>
                                         <?php }
                                         ?>
                             </select>
                            </td>
