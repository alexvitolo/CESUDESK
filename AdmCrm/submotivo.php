...
$squilaSubMotivo = "SELECT ID_SUB_MOTIVO
                         ,SUB_MOTIVO
                     FROM tb_crm_desligamento_sub";

$result_squilaSubMotivo = sqlsrv_prepare($conn, $squilaSubMotivo);
sqlsrv_execute($result_squilaSubMotivo);
                   ...
                   <?php if ($_SESSION['ACESSO'] == 1){ ?>
                      ...
                      <ul class="sub">
                         ...
                         <li class=""><a  href="dimensionamento.php">Dimensionamento</a></li>
                          ...
                          <li class="active"><a  href="submotivo.php">Sub-Motivo</a></li>
                      </ul>
                  </li>
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
            <h3><i class="fa fa-right"></i> Lista de Sub-Motivos </h3>

            <!-- criar formulario -->
              <div class="row mt">
                  <div class="col-md-12">
                      <div class="content-panel">
                        <form name="Form" method="post" id="formulario" action="submotivo.php">
                          <table class="table table-striped table-advance table-hover order-table table-wrapper">
                            ...
                            <a href="cadastroSubMotivo.php"><input style="float:right; margin-right: 50px" type="button" value="Novo Sub-Motivo" ></input></a>
                              <thead>
                              <tr>
                                  <th><i class="fa fa-bullhorn"></i> ID Sub-Motivo </th>
                              ...
                              <tbody>
                              <tr>
                                  <?php  while($row = sqlsrv_fetch_array($result_squilaSubMotivo)) { 
                                    
                                 ?>

                                  <td><?php echo $row['ID_SUB_MOTIVO']; ?></a></td>
                                  <td><?php echo $row['SUB_MOTIVO']; ?></td>
                                  <td>
